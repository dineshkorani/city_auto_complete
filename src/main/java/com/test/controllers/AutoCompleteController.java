...
import com.test.models.GenericResponse;
...
public class AutoCompleteController {
     ...
     *
     */
    @RequestMapping(method = RequestMethod.GET, value = "/v1/suggest_cities" ,produces = MediaType.APPLICATION_JSON_VALUE)
    public ResponseEntity<String> autoComplete(HttpServletRequest httpServletRequest) {
        try{
